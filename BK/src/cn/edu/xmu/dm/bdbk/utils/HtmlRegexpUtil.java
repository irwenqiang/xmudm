...
/**
 * desc:包括过滤HTML标记，转换HTML标记，替换特定HTML标记
 * <code>HtmlRegexpUtil</code>
 * @author chenwq
...
public class HtmlRegexpUtil {
	...
	private final static String regxpForLetter = "<([^>]*)>"; // 过滤所有以<开头以>结尾的标签
	...
	public String replaceNotNeed(String str){
